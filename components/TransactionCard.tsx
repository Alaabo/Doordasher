    ...
    return (
        ...
        >
            <View style={[styles.header, isRTL && styles.rowReverse]}>
                <Text style={styles.id}>{t('transaction.request')} #{$id.substring(0, 8)}</Text>
                <View style={[styles.statusBadge, { backgroundColor: getStatusColor(status) }]}>
                    <Text style={styles.statusText}>{t(`transaction.status.${status}`)}</Text>
                </View>
            </View>
            ...
            <View style={[styles.body]}>
                <View style={[styles.row, isRTL && styles.rowReverse]}>
                    ...
                    <Text style={styles.amount}>{amount}{t('currency.dzd')}</Text>
                </View>
            ...
            <View style={[styles.footer]}>
                <Text style={[styles.footerText, isRTL && styles.textAlignRight]}>
                    {t('request.id')}: {transaction.request.substring(0, 8)}
                </Text>
                <Text style={[styles.footerText, isRTL && styles.textAlignRight]}>
                    {t('request.driver')}: {transaction.driver ? transaction.driver.substring(0, 8) : "pending"}
                </Text>
                <Text style={[styles.footerText, isRTL && styles.textAlignRight]}>
                    {t('transaction.user')}: {transaction.user.substring(0, 8)}
                </Text>
            </View>
        </TouchableOpacity>
    );
