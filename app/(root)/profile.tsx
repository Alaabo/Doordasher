   ...
   <SafeAreaView className='p-2 h-full bg-white' style={{ direction: isRTL ? 'rtl' : 'ltr' }}>
    <View style={{ alignContent: isRTL ? 'flex-end' : 'flex-start' }}>
        ...
        <View className="flex flex-col mt-10">
          <SettingsItem onPress={()=>{router.push('/RequestHistory')}} showArrow={false} icon={images.calendar} title={t('deliveryHistory')} isRTL={isRTL}/>
          <SettingsItem onPress={()=>{router.push('/TransactionHistory')}} showArrow={false}  icon={images.wallet} title={t('TransactionsHistory')} isRTL={isRTL}/>
        </View>
        <SettingsItem
